    ...
    public partial class SettingModelFactory : ISettingModelFactory
    {
        ...
        protected virtual async Task<RobotsTxtSettingsModel> PrepareRobotsTxtSettingsModelAsync(RobotsTxtSettingsModel model = null)
        {
            ...
            model ??= new RobotsTxtSettingsModel
            {
                ...
                DisallowPathsAreaRows = getAreaRows(robotsTxtSettings.DisallowPaths.Count),
                LocalizableDisallowPathsAreaRows = getAreaRows(robotsTxtSettings.LocalizableDisallowPaths.Count),
                AdditionsRulesAreaRows = getAreaRows(robotsTxtSettings.AdditionsRules.Count)
            };
